#pragma checksum "C:\Users\Thuong\source\repos\xBinDataTemplate\xBinDataTemplate\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "E4A14129A21621BBB8578CB974CE006E"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace xBinDataTemplate
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj2_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBinDataTemplate.Models.Drink dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::xBinDataTemplate.Models.Drink) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::xBinDataTemplate.Models.Drink)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::xBinDataTemplate.Models.Drink obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ImageDrink(obj.ImageDrink, phase);
                        this.Update_Title(obj.Title, phase);
                    }
                }
            }
            private void Update_ImageDrink(global::System.String obj, int phase)
            {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBinDataTemplate.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::xBinDataTemplate.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::xBinDataTemplate.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Drinks(global::System.Collections.Generic.List<global::xBinDataTemplate.Models.Drink> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
